    ...
    */
    ...
    public void cgen(PrintStream s) {
        ...
        for(Enumeration e = classes.getElements(); e.hasMoreElements();) {
            ...
            codegen_classtable.addId(TreeConstants.currentClass, currentClass);
            currentClass.code(codegen_classtable, s);
        }
...
class class_ extends Class_ {
    ...
    public void code(CgenClassTable codegen_classtable,PrintStream s) {
        for(Enumeration e = features.getElements(); e.hasMoreElements();) {
            ...
            if(currentFeature instanceof method) {
                ...
                currentMethod.code(codegen_classtable, s);
            }
        }
    }
...
class method extends Feature {
    ...
    public void code(CgenClassTable codegen_classtable,PrintStream s) {
        class_ currentClass = (class_) codegen_classtable.lookup(TreeConstants.currentClass);
        CgenSupport.emitMethodRef(currentClass.getName(), name, s);
        s.print(CgenSupport.LABEL);
        CgenSupport.emitPrologue(3, s); // NOTE: Number depends on certain variables number. You have to change this
        expr.code(s);
        CgenSupport.emitEpilogue(3, false, s); // NOTE: Number depends on certain variables number. You have to change this
    }
